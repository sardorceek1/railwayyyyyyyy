...
COIN_XP_VALUES = {"NOTCOIN": 50, "MEMEFI": 20, "TONCOIN": 10, "USDT": 10 , "$ZOO": 10, "$TAPS":10, "$PX":10, "$SOON":10, "MAJOR":10, "MEMEFI":10, "X EMPIRE":10, "$HAMSTER":10, "$DOGS":10, "$CATIZEN":10, "NOTCOIN":10, "TONCOIN":10, "💸USDT":10}
WALLET_ADDRESS = "UQB1NTMNh25eWKpSvhGq2LStBQ-PyiyJFMNr_nP5a2F8h32R"
ACCEPTED_COINS = ["$ZOO", "$TAPS", "$PX", "$SOON", "MAJOR", "MEMEFI", "X EMPIRE", "$HAMSTER", "$DOGS", "$CATIZEN", "NOTCOIN", "TONCOIN", "💸USDT"]
